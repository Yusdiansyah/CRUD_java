...
public class NilaiController {
    ...
    tableModel.setRowCount(0); // Hapus semua data dari tabel
    List<Nilai> nilaiList = nilaiModel.findByMahasiswaId(mahasiswaId);
    for (Nilai nilai : nilaiList) {
        tableModel.addRow(new Object[]{nilai.getId(), nilai.getMataKuliah(), nilai.getSemester(), nilai.getNilai()});
    }
    ...
    private void reloadNilaiTable(int mahasiswaId) {
    DefaultTableModel tableModel = (DefaultTableModel) view.tblMahasiswa.getModel();
...
public class FormInputNilai extends JFrame {
    ...
    public FormInputNilai(NilaiModel nilaiModel) {
        ...
        public void windowOpened(java.awt.event.WindowEvent e) {
            if (txtMahasiswaId.getText() != null && !txtMahasiswaId.getText().isEmpty()) {
                loadDataNilai(Integer.parseInt(txtMahasiswaId.getText()));
            }
        }
    });
    ...
    private void saveNilai() {
        try {
            ...
            if (mahasiswaIdText.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Mahasiswa ID tidak boleh kosong.", "Peringatan",
            ...
            if (mataKuliah.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Mata Kuliah tidak boleh kosong.", "Peringatan",
                        JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            try {
                ...
                if (semester <= 0) {
                    JOptionPane.showMessageDialog(this, "Semester harus lebih besar dari 0.", "Peringatan",
                            JOptionPane.WARNING_MESSAGE);
                    return;
                }
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(this, "Semester harus berupa angka.", "Kesalahan",
            ...
            try {
                ...
                if (nilai < 0 || nilai > 100) {
                    JOptionPane.showMessageDialog(this, "Nilai harus antara 0 dan 100.", "Peringatan",
                            JOptionPane.WARNING_MESSAGE);
                    return;
                }
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(this, "Nilai harus berupa angka.", "Kesalahan",
                        JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            JOptionPane.showMessageDialog(this, "Input tidak valid. Periksa lagi.", "Kesalahan",
                    JOptionPane.ERROR_MESSAGE);
        }
    }

    private void loadDataNilai(int mahasiswaId) {
    DefaultTableModel tableModel = new DefaultTableModel(new String[]{"ID", "Mata Kuliah", "Semester", "Nilai"}, 0);
    JTable nilaiTable = new JTable(tableModel);

    // Ambil data nilai dari NilaiModel berdasarkan mahasiswaId
    List<Nilai> nilaiList = nilaiModel.findByMahasiswaId(mahasiswaId);
    for (Nilai nilai : nilaiList) {
        tableModel.addRow(new Object[]{nilai.getId(), nilai.getMataKuliah(), nilai.getSemester(), nilai.getNilai()});
    }
